...
function one_login_business_custom_styles($custom) {
	...
	wp_add_inline_style( 'one-login-business-style', $custom );

}

add_action( 'wp_enqueue_scripts', 'one_login_business_custom_styles' );


//Sanitizes Fonts
function one_login_business_sanitize_fonts( $input ) {
	$valid = array(
		'' => 'Select',
